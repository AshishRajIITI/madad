...
import coronaPreventImg from "./images/corona-measures.jpg";
import whoImg from "./images/who-3-factors-poster.jpg";
import womanMaskImg from "./images/woman-with-face-mask-and-disinfectant.jpg";
import awareImg from "./images/awareness.jpg";
  ...
  return (
    <div className="container awareness-div d-flex flex-column bg-white mt-3 mb-3 p-5">
      <Row className="mb-3">
        ...
        >
          <img width="100%" height="400px" src={vaccineImg} alt="vaccination" />
        </Col>
        <Col sm={12} lg={6}>
          <div className="d-flex flex-column justify-content-center align-items-center">
            <p className="desc myth-heading">MYTHS BUSTED</p>
            <ul className="myth-lists d-flex flex-column justify-content-center align-items-center">
              ...
              <li className="list-unstyled m-2 text-center">
                If you've had Covid-19 already, you don't need to get
                vaccinated.
              </li>
              <li className="list-unstyled m-2 text-center">
      ...
      <Row className="blog-row">
        ...
        >
          <p className="desc">
            Not only has COVID-19 affected the physical health but also the
            mental well-being of people. There are huge chances that a mental
            health pandemic will follow as a result of COVID-19. Here, we bring
            you a dose of positivity by presenting the top 100 blogs which will
            make you beleive that you are not alone and we all, together, will
